...
DROP TABLE IF EXISTS inputs.inp_002_01_LFB_Incident_data_from_January_2009_to_December_2012 cascade;

CREATE TABLE inputs.inp_002_01_LFB_Incident_data_from_January_2009_to_December_2012 (
IncidentNumber				text
,DateOfCall				text
,CalYear				text
,TimeOfCall				text
