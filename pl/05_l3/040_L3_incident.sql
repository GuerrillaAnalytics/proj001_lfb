drop table if exists proj001_lfb_1_0_0.l3_incidents; 

create table proj001_lfb_1_0_0.l3_incidents (
...
insert into proj001_lfb_1_0_0.l3_incidents (
incidentnumber_cln		
,dateofcall_cln			
,id_incident_type		
,id_property			
...
from 
(
	select * from proj001_lfb_1_0_0.L2_incidents 
) incidents
left join
(
	select * from proj001_lfb_1_0_0.L3_incident_types	--37
)	incident_types
...
left join
(
	select * from proj001_lfb_1_0_0.L3_property
)	properties
...
left join
(
	select * from proj001_lfb_1_0_0.L3_postcodes 
) pcode
...
/*
select * from proj001_lfb_1_0_0.l3_incidents

select * from proj001_lfb_1_0_0.L2_incidents  limit 5

select count(*) from proj001_lfb_1_0_0.L2_incidents 
485065
